...
from ex2_move_linear import get_position_pawn, get_position_queens, attacked_queen_postion, is_attacked_q, queen_placements, my_answer, create_closest_queen_list
...
def create_board_without_user_queen(r_queen_row, r_queen_col):
...
def menu():
    ...
    while True:
        ...
        if choice == "1":
            ...
            user_queen_board = create_board_without_user_queen(r_queen_row, r_queen_col)
            ...
            closest_queens = create_closest_queen_list(current_attacked_queen_list)
